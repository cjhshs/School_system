...
<head>
    ...
    <style>
        ...
        .login-body .form-control:focus { outline: none; border-color: #3498db; box-shadow: 0 0 0 3px rgba(52,152,219,0.15); }
            ...
            <form method="POST" style="margin-bottom: 0;">
                <div class="mb-3">
                    ...
                    <div class="input-group">
                        ...
                        <input type="text" name="student_number" class="form-control" placeholder="e.g., 202600001" required autofocus>
                    </div>
                </div>
                <div class="mb-3">
