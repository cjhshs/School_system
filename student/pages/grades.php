...
$enrolled_subjects = $conn->query("
    SELECT sub.id, sub.subject_code, sub.description, sub.units, sub.semester, sub.school_year,
           g.id as grade_id, g.prelim, g.midterm, g.final_exam, g.final_grade, g.remarks, g.status as grade_status
