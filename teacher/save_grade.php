...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if ($check->get_result()->num_rows > 0) {
        ...
        $stmt = $conn->prepare("INSERT INTO grades (student_id, subject_id, prelim, midterm, final_exam, final_grade, remarks, semester, school_year, status, teacher_id) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, 'Draft', ?)");
        $stmt->bind_param("iisddssssi", $student_id, $subject_id, $prelim, $midterm, $final_exam, $final_grade, $remarks, $semester, $school_year, $teacher_id);
    }
