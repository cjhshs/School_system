...
<head>
    ...
    <title>Finance Login - CJLG University</title>
    ...
    <style>
        ...
        .login-body .form-control:focus { outline: none; border-color: #f59e0b; box-shadow: 0 0 0 3px rgba(245,158,11,0.15); }
        ...
        .login-body .btn-primary:hover { background: linear-gradient(135deg, #d97706, #b45309); }
        .login-footer { text-align: center; padding-top: 15px; margin-top: 15px; border-top: 1px solid #eee; }
        .login-footer a { color: #f59e0b; text-decoration: none; font-weight: 500; }
