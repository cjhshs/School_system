...
<head>
    ...
    <title>Registrar Login - CJLG University</title>
    ...
    <style>
        ...
        .login-body .form-control:focus { outline: none; border-color: #28a745; box-shadow: 0 0 0 3px rgba(40,167,69,0.15); }
        ...
        .login-body .btn-primary:hover { background: linear-gradient(135deg, #218838, #1aa179); }
        .login-footer { text-align: center; padding-top: 15px; margin-top: 15px; border-top: 1px solid #eee; }
        .login-footer a { color: #28a745; text-decoration: none; font-weight: 500; }
