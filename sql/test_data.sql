-- Test Data for Enrollment System
-- Run this file to populate sample data for testing

USE enrollment_system;

-- ==================== DEPARTMENTS ====================
INSERT INTO departments (id, name, code, description, dean_id, is_active) VALUES 
...
-- ==================== SUBJECTS ====================
INSERT INTO subjects (id, subject_code, subject_name, units, year_level, semester, course_code, is_active) VALUES 
...
-- ==================== COURSE FEES ====================
INSERT INTO course_fees (course_code, fee_name, amount, semester, is_required, description) VALUES 
...
-- ==================== SYSTEM USERS ====================
INSERT INTO system_users (id, employee_id, username, password, first_name, last_name, email, role_id, department_id, is_active) VALUES 
...
-- ==================== PAYMENTS ====================
INSERT INTO payments (id, student_id, or_number, payment_amount, total_fees, balance, payment_method, payment_date, school_year, semester) VALUES 
...
UPDATE departments SET dean_id = 3 WHERE code = 'CS';
